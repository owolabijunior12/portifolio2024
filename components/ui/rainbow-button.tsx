...
export const RainbowButton: React.FC<RainbowButtonProps> = ({
  ...
  return (
    <motion.button
      ...
      className={cn(
        "group relative text-sm container inline-flex h-[50px] font-extrabold w-[100px] animate-rainbow cursor-pointer items-center justify-center rounded-xl border-0 bg-[length:200%] px-8 py-2 text-white transition-colors [background-clip:padding-box,border-box,border-box] [background-origin:border-box] [border:calc(0.08*1rem)_solid_transparent] focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50",
